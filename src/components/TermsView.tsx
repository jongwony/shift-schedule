  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="mx-auto max-w-3xl px-4 py-10 text-sm leading-relaxed text-gray-800">
        ...
        <Section title="제6조 (청약철회 및 환불)" id="refund">
          <ol className="list-decimal space-y-1 pl-5">
            <li><strong>디지털 콘텐츠 특례</strong>: 본 서비스는 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 제5호에 따른
              디지털 콘텐츠로, 이용 시작(활성화) 시점부터 청약철회가 제한됩니다.</li>
            <li><strong>무료 시험 사용</strong>: 회사는 매월 3회의 무료 자동 생성을 제공하여 이용자가 결제 전 서비스를 충분히
              체험할 수 있도록 합니다.</li>
            <li><strong>활성화 정의</strong>: 데이 패스의 활성화는 결제 완료 후 회원이 자동 생성을 처음 호출한 시점을 의미합니다.
              이 시점부터 24시간이 카운트됩니다.</li>
            <li><strong>환불 가능 조건</strong>: 결제 후 단 한 번도 자동 생성을 사용하지 않은 경우(활성화 대기 상태)에 한해
              결제일로부터 7일 이내 환불 요청이 가능합니다.</li>
            <li><strong>환불 불가 조건</strong>: 자동 생성을 1회 이상 사용한 경우(활성화 완료) 환불이 불가능합니다.</li>
